  ...
  return (
    <div className="container">
      ...
      <nav className="tabs-container">
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="tab-icon"><path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"/><line x1="3" y1="6" x2="21" y2="6"/><path d="M16 10a4 4 0 0 1-8 0"/></svg>
                ...
                <div className="grid" style={{ marginTop: '1rem' }}>
                  ...
                  <section className="card">
                    ...
                    {cart.length === 0 ? (
                      ...
                      <>
                        {/* Lista do Carrinho em Cards */}
                        <div className="cart-cards-mobile">
                          {cart.map((item) => (
                            <div key={item.produtoId} className="cart-card-item">
                              <div className="cart-card-info">
                                <span className="cart-card-name">{item.nome}</span>
                                <span className="cart-card-sub">{item.quantidade}x de {formatCurrency(item.valor)}</span>
                              </div>
                              <div className="cart-card-actions">
                                <span className="cart-card-subtotal">{formatCurrency(item.quantidade * item.valor)}</span>
                                <button
                                  type="button"
